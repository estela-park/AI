...
es = EarlyStopping(monitor='loss', patience=10, mode='min', verbose=2)
...
'''
epochs=38, batch_size=128, stopped early 
it took 2 minutes and 34 seconds
entropy: 0.6080189943313599 accuracy: 0.014998302794992924
'''