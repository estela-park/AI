...
model = RandomForestRegressor(min_samples_split=3, n_jobs=-1)
model.fit(x, y)

print('model was set to min_samples_split=3, n_jobs=-1')
print('score:',model.score(x, y))
...
'''
best parameter was RandomForestRegressor(min_samples_split=5, n_jobs=-1)
score: 0.9754447392286921
model was set to min_samples_split=3, n_jobs=-1
score: 0.9806683484036737
'''