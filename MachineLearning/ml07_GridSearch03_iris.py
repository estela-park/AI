...
# > n_esimators coresponds to epochs
parameters = [
...
model = RandomForestClassifier(max_depth=6, min_samples_leaf=7, n_jobs=-1)
model.fit(x, y)

print('model was set to max_depth=6, min_samples_leaf=7, n_jobs=-1')
print('score:',model.score(x, y))

'''
best parameter was RandomForestClassifier(max_depth=8, min_samples_leaf=10, n_jobs=-1)
score: 0.9733333333333334
model was set to max_depth=6, min_samples_leaf=7, n_jobs=-1
