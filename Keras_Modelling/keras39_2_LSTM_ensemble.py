...
hl_l = LSTM(units=32, activation='relu')(inL_l)
hl_r = LSTM(units=32, activation='relu')(inL_r)
...
start = time.time()
es = EarlyStopping(monitor='val_loss', patience=12, mode='min', verbose=2)
...
'''
SimpleRNN
   > prediction: [76.43602] took 4.2 seconds, stopped at 89
LSTM
   > prediction: [85.12362] took 6 seconds, stopped at 95
'''