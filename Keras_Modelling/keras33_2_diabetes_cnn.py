...
hl = Conv1D(64, 2, padding='same', activation='relu')(inputL)
hl = Dropout(0.2)(hl)
...
'''
CNN [epochs=129, batch_size=32] *stopped early
    loss: [3144.7724609375, 47.63518142700195] accuracy: 0.5237515596456263
    [epochs=67, batch_size=8]   *stopped early
    loss: [3084.109130859375, 47.162696838378906] accuracy: 0.5329385148832324
DNN [epochs=240, batch_size=32]
