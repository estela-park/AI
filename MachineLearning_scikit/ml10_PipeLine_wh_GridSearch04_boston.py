...
GridSearch took 5.350250244140625 seconds
best esimator was Pipeline(steps=MinMaxScaler(), RandomForestRegressor(max_depth=9, min_samples_leaf=3, min_samples_split=3, n_jobs=-1))])
best parameter was {'randomforestregressor__n_jobs': -1, 'randomforestregressor__min_samples_split': 3, 'randomforestregressor__min_samples_leaf': 3, 'randomforestregressor__max_depth': 9}
score: 0.9564495955468978
'''