...
# 4/17 ~ 7/31 (106,)
x2 = np.array(data_2[8:-3]).reshape(95, 1)
# 4/26 ~ 7/29 (95,)
...
hl_x1 = GlobalAveragePooling1D()(hl_x1)
...
plot_model(model, to_file='inverted_model_plot.png', show_shapes=True, show_layer_names=True)
# Compilation & Fitting
